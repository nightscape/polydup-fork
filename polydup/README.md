Note: This is a fork of the one on crates.io.
...
1. **Comprehensive**: Scans entire codebase to build complete hash cache
2. **Focused**: Reports only duplicates involving changed files
